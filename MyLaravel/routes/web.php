...
Route::get('/service', [AppsController::class,'service'])->name('service');
Route::get('/about', [AppsController::class,'about'])->name('about');
Route::get('/contact',[AppsController::class,'contact'])->name('contact');
Route::get('/ourteam', [AppsController::class,'ourteam'])->name('team');
// Route::get('/ourteam','AppsController@ourteam');